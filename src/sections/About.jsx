...
function About() {
  return (
    <>
      <div className="dark:bg-lightGray/35 sticky top-0 z-20 -mx-6 mb-4 w-screen bg-midnight/35 px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:opacity-0">
        <h2 className="text-sm font-bold uppercase tracking-widest text lg:sr-only dark:text-gray-800">
          About
        </h2>
      </div>
